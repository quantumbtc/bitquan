...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitquantumd
instance.
...
```
$ bitquantum-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitquantum-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
