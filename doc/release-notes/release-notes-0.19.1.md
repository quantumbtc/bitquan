...
Bitquantum Core version 0.19.1 is now available from:

  <https://bitquantumcore.org/bin/bitquantum-core-0.19.1/>
...
From Bitquantum Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitquantum Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitquantum Core does not yet change appearance when
...
- #17488 fix "bitquantumd already running" warnings on macOS (fanquake)
