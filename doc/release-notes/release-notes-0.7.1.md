Bitquantum version 0.7.1 is now available from:
  http://sourceforge.net/projects/bitquantum/files/Bitquantum/bitquantum-0.7.1/
...
* Clicking on a bitquantum: URI on Windows should now launch Bitquantum-Qt properly.
