Bitquantum Core version 0.10.4 is now available from:

  <https://bitquantum.org/bin/bitquantum-core-0.10.4/>
...
- #6953 `43c2789` Split bitquantum-tx into its own package
- #6953 `dfe0d4d` Include bitquantum-tx binary on Debian/Ubuntu
