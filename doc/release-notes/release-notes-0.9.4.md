Bitquantum Core version 0.9.4 is now available from:

  https://bitquantum.org/bin/0.9.4/
...
this update is incompatible with the Bitquantum system and could lead to consensus
forks.

Bitquantum Core released binaries from https://bitquantum.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitquantum/+archive/ubuntu/bitquantum
- A third-party or self-compiled Bitquantum Core

upgrade to Bitquantum Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
