Bitquantum Core version *0.15.2* is now available from:

  <https://bitquantumcore.org/bin/bitquantum-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitquantum-tx (TheBlueMatt)
