Bitquantum Core version 0.13.2 is now available from:

  <https://bitquantum.org/bin/bitquantum-core-0.13.2/>
...
- #8908 `4a974b2` Update bitquantum-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitquantum-tx to create v2 transactions (btcdrak)
