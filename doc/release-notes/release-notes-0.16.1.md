Bitquantum Core version 0.16.1 is now available from:

  <https://bitquantumcore.org/bin/bitquantum-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitquantumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitquantumd processes are cleaned up when tests end (sdaftuar)
