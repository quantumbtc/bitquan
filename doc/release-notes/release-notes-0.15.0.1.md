Bitquantum Core version *0.15.0.1* is now available from:

  <https://bitquantum.org/bin/bitquantum-core-0.15.0.1/>

and

  <https://bitquantumcore.org/bin/bitquantum-core-0.15.0.1/>
