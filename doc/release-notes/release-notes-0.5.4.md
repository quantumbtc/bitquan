Bitquantum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitquantum/files/Bitquantum/bitquantum-0.5.4/
...
http://gitorious.org/bitquantum/bitquantumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitquantum-Qt notifications under Growl 1.3.
Increase required age of Bitquantum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitquantum properly when installing Bitquantum-Qt over it. (Windows)
