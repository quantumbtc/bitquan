...
This guide describes how to build bitquantumd, command-line utilities, and GUI on NetBSD.
...
There are many ways to configure Bitquantum Core. Here is an example that
