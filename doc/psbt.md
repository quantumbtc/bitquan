# PSBT Howto for Bitquantum Core

Since Bitquantum Core 0.17, an RPC interface exists for Partially Signed Bitquantum
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/bitquantum/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Bitquantum transactions that are not fully signed
...
#### Multisig with multiple Bitquantum Core instances
