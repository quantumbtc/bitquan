...
This document provides guidelines for internationalization of the Bitquantum Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `bitquantum_en.ts` remains unchanged.
