...
By default, bitquantumd will dump mempool on shutdown and
...
class MempoolPersistTest(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitquantumd from writing mempool.dat to disk. Verify that `savemempool` fails")
