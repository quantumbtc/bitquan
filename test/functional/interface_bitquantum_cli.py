#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Bitquantum Core developers
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bitquantum-cli -h\" for help or \"bitquantum-cli listwallets\" to see "
...
class TestBitquantumCli(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitquantum-cli getblockchaininfo`")
        ...
        # Prevent bitquantum-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bitquantum-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitquantum-cli getwalletinfo return expected wallet info")
            ...
            # Test bitquantum-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestBitquantumCli(__file__).main()
