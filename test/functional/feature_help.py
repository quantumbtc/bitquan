#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Bitquantum Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting bitquantum with -h works as expected."""

from test_framework.test_framework import BitquantumTestFramework
from test_framework.util import assert_equal

class HelpTest(BitquantumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitquantum with -h for help text")
        ...
        self.log.info("Start bitquantum with -version for version information")
        ...
        self.log.info("Start bitquantumd with -fakearg to make sure it does not start")
