...
Verify that a bitquantumd node can use an external signer command.
...
class RPCSignerTest(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitquantumd with -signer=<cmd>',
