...
class TransactionTimeRescanTest(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        # send 10 btq to user's first watch-only address
        self.log.info('Send 10 btq to user')
        ...
        # send 5 btq to our second watch-only address
        self.log.info('Send 5 btq to user')
        ...
        # send 1 btq to our third watch-only address
