...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bitquantum/bitquantum/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bitquantum/bitquantum/blob/master/doc/tracing.md#tracepoint-validationblock_connected
