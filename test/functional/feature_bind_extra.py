...
"""
Test starting bitquantumd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitquantumTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that bitquantumd has bound on "::1" (for RPC) and "::" (for P2P).
