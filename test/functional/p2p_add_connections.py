...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitquantumd node closes feeler connections as soon as a version
...
class P2PAddConnections(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        # bitquantumd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitquantumd sends its own version prior to processing
