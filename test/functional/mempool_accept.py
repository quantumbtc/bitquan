...
class MempoolAcceptanceTest(BitquantumTestFramework):
    ...
    def run_test(self):
        ...
        # Settings are listed in BTQ/kvB
        ...
        self.mempool_size = 0
        # Also check feerate. 1BTQ/kvB fails
        assert_raises_rpc_error(-8, "Fee rates larger than or equal to 1BTQ/kvB are not accepted", lambda: self.check_mempool_result(
