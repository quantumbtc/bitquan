...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitquantumTestFramework
    pass


class ExampleTest(BitquantumTestFramework):
    # Each functional test is a subclass of the BitquantumTestFramework class.
    ...
    def custom_method(self):
        ...
        BitquantumTestFramework class so other tests can use it."""
