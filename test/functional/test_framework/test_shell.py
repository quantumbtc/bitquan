...
class TestShell:
    """Wrapper Class for BitquantumTestFramework.

    The TestShell class extends the BitquantumTestFramework
    ...
    class __TestShell(BitquantumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitquantumTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # BitquantumTestFramework instances are supposed to be constructed with the path
