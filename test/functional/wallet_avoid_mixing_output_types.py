...
random value payments which sum to 10BTQ for each output type to Bob,
for a total of 40BTQ in Bob's wallet.
...
class AddressInputTypeGrouping(BitquantumTestFramework):
