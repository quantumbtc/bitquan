...
Bitquantum Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Bitquantum Core

**When configuring Bitquantum Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Bitquantum Core:
...
variables will be set when generating the Bitquantum Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
