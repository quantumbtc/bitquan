...
#ifndef BITQUANTUM_RPC_PROTOCOL_H
#define BITQUANTUM_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitquantumd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Bitquantum is not connected
...
#endif // BITQUANTUM_RPC_PROTOCOL_H
