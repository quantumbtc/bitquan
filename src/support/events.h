// Copyright (c) 2016-2018 The Bitquantum Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITQUANTUM_SUPPORT_EVENTS_H
#define BITQUANTUM_SUPPORT_EVENTS_H
...
#endif // BITQUANTUM_SUPPORT_EVENTS_H
