...
#ifndef BITQUANTUM_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BITQUANTUM_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BITQUANTUM_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
