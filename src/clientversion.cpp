 ...
 * for both bitquantumd and bitquantum-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <bitquantum-build-info.h>
// The <bitquantum-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
#define GIT_COMMIT_ID "f15eac76c48e3a6242ba8d57ea7f5af0df83bf74"
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bitquantum/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Bitquantum Core copyright is not removed by accident
    if (copyright_devs.find("Bitquantum Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitquantum Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitquantum/bitquantum>";
