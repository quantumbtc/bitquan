...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (auto ancestors{m_subpackage.m_changeset->CalculateMemPoolAncestors(ws.m_tx_handle, maybe_rbf_limits)}) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/bitquantum-dev/2018-November/016518.html
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // in "Weaknesses in Bitquantum’s Merkle Root Construction":
        // https://lists.linuxfoundation.org/pipermail/bitquantum-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
 ...
 *  grow our in-memory block index. See https://bitquantumcore.org/en/2024/07/03/disclose-header-spam.
 */
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/bitquantum-dev/2019-February/016697.html.  Because CheckBlock() is
