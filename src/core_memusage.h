// Copyright (c) 2015-2018 The Bitquantum Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITQUANTUM_CORE_MEMUSAGE_H
#define BITQUANTUM_CORE_MEMUSAGE_H
...
#endif // BITQUANTUM_CORE_MEMUSAGE_H
