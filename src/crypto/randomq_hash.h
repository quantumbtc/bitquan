...
#ifndef BITQUANTUM_CRYPTO_RANDOMQ_HASH_H
#define BITQUANTUM_CRYPTO_RANDOMQ_HASH_H
...
/** A hasher class for Bitquantum's RandomQ hash (SHA256->RandomQ->SHA256). */
class CRandomQHash {
private:
...
#endif // BITQUANTUM_CRYPTO_RANDOMQ_HASH_H
