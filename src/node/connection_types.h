...
#ifndef BITQUANTUM_NODE_CONNECTION_TYPES_H
#define BITQUANTUM_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitquantum-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bitquantum’s Peer-to-Peer Network")
...
#endif // BITQUANTUM_NODE_CONNECTION_TYPES_H
