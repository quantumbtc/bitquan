...
//! Entry point for BitquantumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitquantumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitquantumGUI tests.
void AppTests::guiTests(BitquantumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitquantumGUI::consoleShown, this, &AppTests::consoleTests);
