...
{
    // Test that the bug https://github.com/bitquantum-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitquantum-core/gui/pull/568.
    // With fListen=false in ~/.config/Bitquantum/Bitquantum-Qt.conf and all else left as default,
    // bitquantum-qt should set both -listen and -listenonion to false and start successfully.
