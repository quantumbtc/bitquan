      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitquantumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitquantumAtStartup);
    ...
    ui->bitquantumAtStartup->setToolTip(ui->bitquantumAtStartup->toolTip().arg(CLIENT_NAME));
    ui->bitquantumAtStartup->setText(ui->bitquantumAtStartup->text().arg(CLIENT_NAME));

    ui->openBitquantumConfButton->setToolTip(ui->openBitquantumConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new BitquantumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitquantumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitquantumConfButton_clicked()
{
