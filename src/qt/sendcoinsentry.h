...
#ifndef BITQUANTUM_QT_SENDCOINSENTRY_H
#define BITQUANTUM_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending bitquantums.
 */
...
#endif // BITQUANTUM_QT_SENDCOINSENTRY_H
