...
#ifndef BITQUANTUM_QT_BITQUANTUMGUI_H
#define BITQUANTUM_QT_BITQUANTUMGUI_H
...
/**
  Bitquantum GUI main class. This class represents the main window of the Bitquantum UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitquantumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitquantumGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitquantumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitquantum wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BitquantumUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitquantum Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BitquantumUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BITQUANTUM_QT_BITQUANTUMGUI_H
