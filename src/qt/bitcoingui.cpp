...
const std::string BitquantumGUI::DEFAULT_UIPLATFORM =
...
BitquantumGUI::BitquantumGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &BitquantumGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &BitquantumGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &BitquantumGUI::showModalOverlay);
...
void BitquantumGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitquantum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitquantum: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &BitquantumGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &BitquantumGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &BitquantumGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitquantum addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitquantum addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Bitquantum Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Bitquantum Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a bitquantum: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bitquantum command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &BitquantumGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &BitquantumGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &BitquantumGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &BitquantumGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &BitquantumGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &BitquantumGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &BitquantumGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &BitquantumGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &BitquantumGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &BitquantumGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &BitquantumGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &BitquantumGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &BitquantumGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &BitquantumGUI::showDebugWindow);
}

void BitquantumGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void BitquantumGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &BitquantumGUI::setCurrentWalletBySelectorIndex);
...
void BitquantumGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &BitquantumGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &BitquantumGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &BitquantumGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &BitquantumGUI::showProgress);
...
#ifdef ENABLE_WALLET
void BitquantumGUI::enableHistoryAction(bool privacy)
{
...
void BitquantumGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &BitquantumGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &BitquantumGUI::removeWallet);
...
WalletController* BitquantumGUI::getWalletController()
{
    return m_wallet_controller;
}

void BitquantumGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &BitquantumGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &BitquantumGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &BitquantumGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &BitquantumGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &BitquantumGUI::incomingTransaction);
    connect(this, &BitquantumGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void BitquantumGUI::removeWallet(WalletModel* walletModel)
{
...
void BitquantumGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void BitquantumGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void BitquantumGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void BitquantumGUI::setWalletActionsEnabled(bool enabled)
{
...
void BitquantumGUI::createTrayIcon()
{
...
void BitquantumGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &BitquantumGUI::toggleHidden);
...
void BitquantumGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void BitquantumGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void BitquantumGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void BitquantumGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void BitquantumGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void BitquantumGUI::openClicked()
{
...
void BitquantumGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void BitquantumGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void BitquantumGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void BitquantumGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void BitquantumGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void BitquantumGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void BitquantumGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void BitquantumGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Bitquantum network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void BitquantumGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void BitquantumGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void BitquantumGUI::updateHeadersSyncProgressLabel()
{
...
void BitquantumGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void BitquantumGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &BitquantumGUI::quitRequested);
...
void BitquantumGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void BitquantumGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &BitquantumGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void BitquantumGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void BitquantumGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &BitquantumGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &BitquantumGUI::show);
                e->ignore();
            }
        }
    }
...
void BitquantumGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void BitquantumGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void BitquantumGUI::incomingTransaction(const QString& date, BitquantumUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(BitquantumUnits::formatWithUnit(unit, amount, true));
...
void BitquantumGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void BitquantumGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool BitquantumGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool BitquantumGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void BitquantumGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void BitquantumGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void BitquantumGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void BitquantumGUI::updateProxyIcon()
{
    std::string ip_port;
...
void BitquantumGUI::updateWindowTitle()
{
...
void BitquantumGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void BitquantumGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void BitquantumGUI::detectShutdown()
{
...
void BitquantumGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void BitquantumGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(BitquantumGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = BitquantumGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void BitquantumGUI::subscribeToCoreSignals()
{
...
void BitquantumGUI::unsubscribeFromCoreSignals()
{
...
bool BitquantumGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<BitquantumUnit> units = BitquantumUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const BitquantumUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, BitquantumUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const BitquantumUnit u : BitquantumUnits::availableUnits()) {
        menu->addAction(BitquantumUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(BitquantumUnit newUnits)
{
    setText(BitquantumUnits::longName(newUnits));
}
