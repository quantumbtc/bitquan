...
#ifndef BITQUANTUM_QT_GUIUTIL_H
#define BITQUANTUM_QT_GUIUTIL_H
...
/** Utility functions used by the Bitquantum Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitquantum:" URI into recipient object, return true on successful parsing
