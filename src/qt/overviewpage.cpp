...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = BitquantumUnits::formatWithUnit(unit, amount, true, BitquantumUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    BitquantumUnit unit{BitquantumUnit::BTQ};
...
{
    BitquantumUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(BitquantumUnits::formatWithPrivacy(unit, balances.balance, BitquantumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(BitquantumUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, BitquantumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(BitquantumUnits::formatWithPrivacy(unit, balances.immature_balance, BitquantumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(BitquantumUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, BitquantumUnits::SeparatorStyle::ALWAYS, m_privacy));
