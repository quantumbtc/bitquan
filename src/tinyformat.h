...
#include <algorithm>
#include <attributes.h> // Added for Bitquantum Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Bitquantum Core
#include <util/string.h> // Added for Bitquantum Core
...
// Added for Bitquantum Core. Similar to std::runtime_format from C++26.
...
// Added for Bitquantum Core. Wrapper for checking format strings at compile time.
