...
#ifndef BITQUANTUM_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define BITQUANTUM_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // BITQUANTUM_KERNEL_DISCONNECTED_TRANSACTIONS_H
