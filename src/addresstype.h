...
#ifndef BITQUANTUM_ADDRESSTYPE_H
#define BITQUANTUM_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitquantum address
 */
...
/**
 * Generate a Bitquantum scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // BITQUANTUM_ADDRESSTYPE_H
