...
//! @file
//! @brief Common init functions shared by bitquantum-node, bitquantum-wallet, etc.

#ifndef BITQUANTUM_INIT_COMMON_H
#define BITQUANTUM_INIT_COMMON_H
...
#endif // BITQUANTUM_INIT_COMMON_H
