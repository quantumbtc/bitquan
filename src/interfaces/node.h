...
#ifndef BITQUANTUM_INTERFACES_NODE_H
#define BITQUANTUM_INTERFACES_NODE_H
...
//! Top-level interface for a bitquantum node (bitquantumd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or bitquantum.conf.
...
#endif // BITQUANTUM_INTERFACES_NODE_H
