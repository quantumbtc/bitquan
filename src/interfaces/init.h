...
#ifndef BITQUANTUM_INTERFACES_INIT_H
#define BITQUANTUM_INTERFACES_INIT_H
...
//! (bitquantum-gui, bitquantum-node, bitquantum-wallet, bitquantumd, bitquantum-qt) and each
...
#endif // BITQUANTUM_INTERFACES_INIT_H
