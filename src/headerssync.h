...
#ifndef BITQUANTUM_HEADERSSYNC_H
#define BITQUANTUM_HEADERSSYNC_H
 ...
 *
 * The Bitquantum protocol does not offer an easy way to determine the work on a
...
#endif // BITQUANTUM_HEADERSSYNC_H
