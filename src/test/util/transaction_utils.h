// Copyright (c) 2019-2020 The Bitquantum Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITQUANTUM_TEST_UTIL_TRANSACTION_UTILS_H
#define BITQUANTUM_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BITQUANTUM_TEST_UTIL_TRANSACTION_UTILS_H
