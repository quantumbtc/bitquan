...
#ifndef BITQUANTUM_TEST_SCRIPTNUM10_H
#define BITQUANTUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitquantum Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITQUANTUM_TEST_SCRIPTNUM10_H
