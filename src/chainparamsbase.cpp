...
{
    // Only support mainnet - other networks disabled for simplified deployment
    ...
    // Disabled network options - commented out to prevent usage
    /*
...
{
    // Only support mainnet - force all other networks to use mainnet
    switch (chain) {
    case ChainType::MAIN:
