...
#ifndef BITQUANTUM_WALLET_WALLET_H
#define BITQUANTUM_WALLET_WALLET_H
...
public:
     ...
     * bitquantum-wallet tool code or by wallet migration code. If this is called
...
#endif // BITQUANTUM_WALLET_WALLET_H
