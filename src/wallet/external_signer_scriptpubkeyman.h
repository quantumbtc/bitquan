// Copyright (c) 2019-2021 The Bitquantum Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITQUANTUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITQUANTUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITQUANTUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
