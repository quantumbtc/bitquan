...
#ifndef BITQUANTUM_SCRIPT_SCRIPT_H
#define BITQUANTUM_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Bitquantum always counted CHECKMULTISIGs
...
#endif // BITQUANTUM_SCRIPT_SCRIPT_H
