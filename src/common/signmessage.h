...
#ifndef BITQUANTUM_COMMON_SIGNMESSAGE_H
#define BITQUANTUM_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bitquantum address, it must refer to a public key.
...
#endif // BITQUANTUM_COMMON_SIGNMESSAGE_H
