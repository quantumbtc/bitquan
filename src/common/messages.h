...
// Copyright (c) 2009-2020 The Bitquantum Core developers
...
#ifndef BITQUANTUM_COMMON_MESSAGES_H
#define BITQUANTUM_COMMON_MESSAGES_H
...
#endif // BITQUANTUM_COMMON_MESSAGES_H
