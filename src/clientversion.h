...
#ifndef BITQUANTUM_CLIENTVERSION_H
#define BITQUANTUM_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by bitquantum-build-config.h or in any other way
#endif
...
#endif // BITQUANTUM_CLIENTVERSION_H
