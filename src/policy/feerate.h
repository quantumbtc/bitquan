...
#ifndef BITQUANTUM_POLICY_FEERATE_H
#define BITQUANTUM_POLICY_FEERATE_H
...
enum class FeeEstimateMode {
    ...
    BTQ_KVB,      //!< Use BTQ/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BTQ_KVB) const;
...
#endif // BITQUANTUM_POLICY_FEERATE_H
