...
#ifndef BITQUANTUM_PSBT_H
#define BITQUANTUM_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Bitquantum transaction.) Returns true if the merge succeeded, false otherwise. */
