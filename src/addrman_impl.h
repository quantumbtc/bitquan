...
#ifndef BITQUANTUM_ADDRMAN_IMPL_H
#define BITQUANTUM_ADDRMAN_IMPL_H
 ...
 * see https://bitquantumcore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // BITQUANTUM_ADDRMAN_IMPL_H
