...
#ifndef BITQUANTUM_ARITH_UINT256_H
#define BITQUANTUM_ARITH_UINT256_H
...
public:
     ...
     *
     * Bitquantum only uses this "compact" format for encoding difficulty
...
#endif // BITQUANTUM_ARITH_UINT256_H
