// Copyright (c) 2018-2019 The Bitquantum Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITQUANTUM_UTIL_THREADNAMES_H
#define BITQUANTUM_UTIL_THREADNAMES_H
...
#endif // BITQUANTUM_UTIL_THREADNAMES_H
