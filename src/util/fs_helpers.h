...
// Copyright (c) 2009-2023 The Bitquantum Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITQUANTUM_UTIL_FS_HELPERS_H
#define BITQUANTUM_UTIL_FS_HELPERS_H
...
#endif // BITQUANTUM_UTIL_FS_HELPERS_H
