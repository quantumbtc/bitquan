...
#ifndef BITQUANTUM_IPC_CAPNP_COMMON_TYPES_H
#define BITQUANTUM_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between bitquantum processes.
...
//! Functions to serialize / deserialize common bitquantum types.
namespace mp {
...
#endif // BITQUANTUM_IPC_CAPNP_COMMON_TYPES_H
