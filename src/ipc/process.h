...
#ifndef BITQUANTUM_IPC_PROCESS_H
#define BITQUANTUM_IPC_PROCESS_H
...
//! IPC process interface for spawning bitquantum processes and serving requests
...
#endif // BITQUANTUM_IPC_PROCESS_H
