...
# Extract options
function __fish_bitquantum_tx_get_options
...
# Extract commands
function __fish_bitquantum_tx_get_commands
...
# Add options
complete \
    --command bitquantum-tx \
    --condition "not __fish_bitquantum_seen_cmd (__fish_bitquantum_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitquantum_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitquantum-tx \
    --arguments "(__fish_bitquantum_tx_get_commands)" \
    --no-files
