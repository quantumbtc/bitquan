...
complete --command bitquantum-qt --no-files

# Extract options
function __fish_bitquantumqt_get_options
...
complete \
    --command bitquantum-qt \
    --arguments "(__fish_bitquantumqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitquantum-qt \
...
complete \
    --command bitquantum-qt \
    --arguments "(__fish_bitquantumqt_get_options --nofiles)"
