...
"""Example logging Bitquantum Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitquantumd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[bitquantumd_with_usdts])
