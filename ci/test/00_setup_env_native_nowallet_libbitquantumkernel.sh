...
export CONTAINER_NAME=ci_native_nowallet_libbitquantumkernel
...
export GOAL="install"
export BITQUANTUM_CONFIG="-DREDUCE_EXPORTS=ON -DBUILD_UTIL_CHAINSTATE=ON -DBUILD_KERNEL_LIB=ON -DBUILD_SHARED_LIBS=ON"
